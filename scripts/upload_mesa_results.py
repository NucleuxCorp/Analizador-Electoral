...
def build_row(jsonl_row: dict) -> dict:
    ...
    return {
        ...
        "e14c_status": _src_status("e14c"),
        "e14t_status": _src_status("e14t"),
        "e14d_status": _src_status("e14d"),
        ...
        "cross_discrepant_fields": cong_summary.get("cross_discrepant_fields") or [],
        "tachon_suspicious": tachon_suspicious,
        "tachon_max_score": tachon_max_score,

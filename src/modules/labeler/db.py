...
# ---------------------------------------------------------------------------
# transversal_review_decisions — visual review panel CRUD (ported from
# production, transversal-decisions-port; unconsumed until
# mesa-findings-consolidation Phase B wires it into admin_mesa_detail_view)
# ---------------------------------------------------------------------------
